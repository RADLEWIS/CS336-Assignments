...
from cs336_systems.flash_atten import FlashAttention, FlashAttentionTriton
from cs336_systems.ddp_overlap import DDPOverlapBuckets, DDPOverlap
from cs336_systems.optimizer import OptimShard
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    return DDPOverlapBuckets(module, bucket_size_mb)
    """
    Returns a torch.nn.Module container that handles
    parameter broadcasting and gradient synchronization for
    distributed data parallel training.
...
def get_sharded_optimizer(params, optimizer_cls: Type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    return OptimShard(params, optimizer_cls, **kwargs)
    """
