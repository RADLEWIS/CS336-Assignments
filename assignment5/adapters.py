...
from cs336_alignment.sft import tokenizer_prompt_and_output, compute_entropy, get_reponse_log_probs, masked_normalize, sft_microbatch_train_step
from cs336_alignment.grpo import compute_group_normalized_rewards, compute_naive_policy_gradient_loss, compute_grop_clip_loss, compute_policy_gradient_loss, masked_mean, grpo_mircobatch_train_step
...
def run_grpo_microbatch_train_step(
    ...
    """
    return grpo_mircobatch_train_step(policy_log_probs, response_mask, gradient_accumulation_steps, loss_type, raw_rewards, advantages, old_log_probs, cliprange)
